  ...
  return (
    ...
    >
      <motion.div
        ...
        className="group rounded-xl p-6 border border-white/[0.07] flex flex-col gap-3 transition-colors duration-200 hover:border-white/[0.15] h-full"
      >
        <div
