      ...
      {!open ? (
        ...
        <div style={{
          ...
          <button
            ...
            onMouseEnter={e => {
              (e.currentTarget as HTMLButtonElement).style.background = rgba(t, 0.22);
              (e.currentTarget as HTMLButtonElement).style.borderColor = rgba(t, 0.6);
            }}
            onMouseLeave={e => {
              (e.currentTarget as HTMLButtonElement).style.background = rgba(t, 0.12);
              (e.currentTarget as HTMLButtonElement).style.borderColor = rgba(t, 0.4);
            }}
          >
            See full breakdown →
          </button>
                  ...
                  <div style={{ flex: 1 }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 10, flexWrap: 'wrap', marginBottom: 4 }}>
                      ...
                      <span style={{
                        ...
                        background: rgba(t, 0.1), border: `1px solid ${rgba(t, 0.25)}`,
                        color: t,
                      }}>
                        {platform.type}
                      </span>
                    ...
                    <ul style={{ margin: 0, padding: 0, listStyle: 'none', display: 'flex', flexDirection: 'column', gap: 8 }}>
                      {platform.highlights.map((h, j) => (
                        <li key={j} style={{ display: 'flex', gap: 10, alignItems: 'flex-start' }}>
                          ...
                          <span style={{ fontSize: 13, color: 'rgba(255,255,255,0.58)', lineHeight: 1.6 }}>
                            {h}
                          </span>
                        </li>
                      ))}
